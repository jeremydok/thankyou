...
class Player:
    def __init__(self, device: audiobusio.I2SOut, buttons: Buttons, display: Display) -> None:
        self.device = device
    ...
    def showVol(self):
        self.display.printLine("Vol: {0:3.0f}%".format(self.mixer.voice[0].level * 100), 3)
